<x-guest-layout>
    <main class="relative flex min-h-screen items-center justify-center overflow-hidden bg-slate-100 px-4 py-10 text-slate-900 transition-colors dark:bg-slate-950 dark:text-white sm:px-6">
        ...
        <section class="relative z-10 w-full max-w-4xl overflow-hidden rounded-[1.75rem] border border-white/60 bg-white shadow-2xl shadow-red-950/20 dark:border-slate-800 dark:bg-slate-900 dark:shadow-black/30" aria-labelledby="role-selection-title">
