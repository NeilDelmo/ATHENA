...
<section data-revision-section="section-signatories" class="rounded-xl border border-gray-200 bg-white p-5 dark:border-gray-700 dark:bg-gray-900">
    <div class="flex flex-wrap items-center justify-between gap-3"><h3 class="text-sm font-bold dark:text-white">Signature names</h3><a href="{{ route('signatories.edit', ['proposalDraft' => $proposalDraft, 'paper' => $paper]) }}" class="text-sm font-semibold text-red-700 dark:text-red-300">Choose signatories</a></div>
