<section
    class="mb-8 flex min-h-[640px] overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-xl shadow-gray-200/50 dark:border-slate-800 dark:bg-slate-900 dark:shadow-black/20 lg:h-[min(780px,calc(100dvh-10rem))]"
