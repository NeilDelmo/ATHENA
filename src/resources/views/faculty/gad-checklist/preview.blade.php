    ...
    <body class="gad-preview-page">
        <section class="gad-page gad-page-one" aria-label="Box 7a GAD Generic Checklist page 1">
            ...
            <table class="gad-table gad-score-table">
                ...
                <tbody>
                    <tr><td class="gad-element"><strong>1.0&nbsp;&nbsp;&nbsp;Involvement of women and men</strong><br><span>(max score: 2; 1 for each item)</span></td><td></td><td></td><td></td><td class="gad-thick-score"></td><td></td></tr>
                    <tr><td>1.1 Participation of women and men in beneficiary groups in problem identification<br><span>(possible scores: 0, 0.5, 1.0)</span></td><td></td><td></td><td></td><td></td><td></td></tr>
                    <tr><td>1.2 Participation of women and men in beneficiary groups in project design <span>(possible scores: 0, 0.5, 1.0)</span></td><td></td><td></td><td></td><td></td><td></td></tr>
                    <tr><td class="gad-element"><strong>2.0 Collection of sex-disaggregated data and gender-related information</strong><br><span>(possible scores: 0, 1.0, 2.0)</span></td><td></td><td></td><td></td><td class="gad-thick-score"></td><td></td></tr>
                    <tr><td class="gad-element"><strong>3.0 Conduct of gender analysis and identification of gender issues</strong><br><span>(max score: 2; 1 for each item)</span></td><td></td><td></td><td></td><td class="gad-thick-score"></td><td></td></tr>
                    <tr><td>3.1 Analysis of gender gaps and inequalities related to gender roles, perspectives and needs, or access to and control of resources<br><span>(possible scores: 0, 0.5, 1.0)</span></td><td></td><td></td><td></td><td></td><td></td></tr>
                    <tr><td>3.2 Analysis of constraints and opportunities related to women and men&rsquo;s participation in the project<br><span>(possible scores: 0, 0.5, 1.0)</span></td><td></td><td></td><td></td><td></td><td></td></tr>
                    <tr class="gad-total-row"><th>TOTAL GAD SCORE&mdash;<br>PROJECT IDENTIFICATION<br>STAGE</th><td colspan="3"></td><td class="gad-thick-score"></td><td></td></tr>
                </tbody>
            </table>
        ...
        <section class="gad-page gad-page-two" aria-label="Box 7a GAD Generic Checklist page 2">
            <table class="gad-table gad-score-table">
                ...
                <tbody>
                    <tr><td class="gad-element"><strong>4.0 Gender equality goals, outcomes, and outputs</strong><br><span>(possible scores: 0, 1.0, 2.0)</span><br>Does the project have clearly stated gender equality goals, objectives, outcomes, or outputs?</td><td></td><td></td><td></td><td class="gad-thick-score"></td><td></td></tr>
                    <tr><td class="gad-element"><strong>5.0 Matching of strategies with gender issues</strong><br><span>(possible scores: 0, 1.0, 2.0)</span><br>Do the strategies and activities match the gender issues and gender equality goals identified?</td><td></td><td></td><td></td><td class="gad-thick-score"></td><td></td></tr>
                    <tr><td class="gad-element"><strong>6.0 Gender analysis of likely impacts of the project</strong><br><span>(max score: 2; for each item or question, 0.67)</span></td><td></td><td></td><td></td><td class="gad-thick-score"></td><td></td></tr>
                    <tr><td>6.1 Are women and girl children among the direct or indirect beneficiaries?<br><span>(possible scores: 0, 0.33, 0.67)</span></td><td></td><td></td><td></td><td></td><td></td></tr>
                    <tr><td>6.2 Has the project considered its long-term impact on women&rsquo;s socioeconomic status and empowerment?<br><span>(possible scores: 0, 0.33, 0.67)</span></td><td></td><td></td><td></td><td></td><td></td></tr>
                    <tr><td>6.3 Has the project included strategies for avoiding or minimizing negative impact on women&rsquo;s status and welfare?<br><span>(possible scores: 0, 0.33, 0.67)</span></td><td></td><td></td><td></td><td></td><td></td></tr>
                    <tr><td class="gad-element"><strong>7.0 Monitoring targets and indicators</strong><br><span>(possible scores: 0, 1.0, 2.0)</span><br>Does the project include gender equality targets and indicators to measure gender equality outputs and outcomes?</td><td></td><td></td><td></td><td class="gad-thick-score"></td><td></td></tr>
                    <tr><td class="gad-element"><strong>8.0 Sex-disaggregated database requirement</strong><br><span>(possible scores: 0, 1.0, 2.0)</span><br>Does the project monitoring and evaluation (M&amp;E) system require the collection of sex-disaggregated data?</td><td></td><td></td><td></td><td class="gad-thick-score"></td><td></td></tr>
                    <tr><td class="gad-element"><strong>9.0 Resources</strong> <span>(max score: 2; for each item or question, 1)</span></td><td></td><td></td><td></td><td class="gad-thick-score"></td><td></td></tr>
                    <tr><td>9.1 Is the project&rsquo;s budget allotment sufficient for gender equality promotion or integration? OR, will the project tap counterpart funds from LGUs/partners for its GAD efforts?<br><span>(possible scores: 0, 0.5, 1.0)</span></td><td></td><td></td><td></td><td></td><td></td></tr>
                    <tr><td>9.2 Does the project have the expertise to promote gender equality and women&rsquo;s empowerment? OR, is the project committing itself to invest project staff time in building capacities within the project to integrate GAD or promote gender equality?<br><span>(possible scores: 0, 0.5, 1.0)</span></td><td></td><td></td><td></td><td></td><td></td></tr>
                </tbody>
            </table>
        ...
        <section class="gad-page gad-page-three" aria-label="Box 7a GAD Generic Checklist page 3">
            <table class="gad-table gad-score-table gad-score-table-final">
                ...
                <tbody>
                    <tr><td class="gad-element"><strong>10 Relationship with the agency&rsquo;s GAD efforts</strong><br><span>(max score: 2; for each question or item, 0.67)</span></td><td></td><td></td><td></td><td class="gad-thick-score"></td><td></td></tr>
                    <tr><td>10.1 Will the project build on or strengthen the agency/NCRFW/government&rsquo;s commitment to the empowerment of women? <span>(possible scores: 0, 0.33, 0.67)</span><br>IF THE AGENCY HAS NO GAD PLAN: Will the project help towards the formulation of the implementing agency&rsquo;s GAD plan?</td><td></td><td></td><td></td><td></td><td></td></tr>
                    <tr><td>10.2 Will it build on the initiatives or actions of other organizations in the area? <span>(possible scores: 0, 0.33, 0.67)</span></td><td></td><td></td><td></td><td></td><td></td></tr>
                    <tr><td>10.3 Does the project have an exit plan that will ensure the sustainability of GAD efforts and benefits? <span>(possible scores: 0, 0.33, 0.67)</span></td><td></td><td></td><td></td><td></td><td></td></tr>
                    <tr class="gad-total-row"><th colspan="4">TOTAL GAD SCORE FOR PROJECT DEVELOPMENT STAGE</th><td class="gad-thick-score"></td><td></td></tr>
                    <tr class="gad-total-row"><th colspan="4">TOTAL GAD SCORE FOR THE PROJECT IDENTIFICATION<br>AND DESIGN STAGES</th><td class="gad-thick-score"></td><td></td></tr>
                </tbody>
            </table>
