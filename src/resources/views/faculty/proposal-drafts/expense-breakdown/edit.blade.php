<x-app-layout>
    ...
    <div
        ...
        x-data="proposalDraftExpenseBreakdown({
            ...
            updateUrl: @js(route('faculty.proposal-drafts.expense-breakdown.update', $proposalDraft)),
    ...
    >
        ...
        <form data-paper-form data-expense-breakdown-autosave-form x-ref="form" action="{{ route('faculty.proposal-drafts.expense-breakdown.update', $proposalDraft) }}" method="POST" class="space-y-6" novalidate>
            @csrf
            @method('PUT')
