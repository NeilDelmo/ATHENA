<x-app-layout>
    ...
    >
        ...
        <p class="text-[10px] font-black uppercase tracking-[0.18em] text-gray-400">Research tools</p>
        </div>
        ...
        <div class="athena-readable mb-5 overflow-x-auto border-b border-gray-200">
            <nav class="flex min-w-max gap-6" aria-label="Research help tools" role="tablist">
                ...
                <button
                    ...
                    :class="activeResearchTool === 'turnitin' ? 'border-emerald-600 text-emerald-700' : 'border-transparent text-gray-500 hover:border-emerald-300 hover:text-emerald-700'"
                    class="flex items-center gap-2 border-b-2 px-1 pb-3 text-xs font-bold transition"
                >
