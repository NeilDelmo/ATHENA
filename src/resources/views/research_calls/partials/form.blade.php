...
>
    ...
    <div class="space-y-4">
        <div class="grid gap-4 md:grid-cols-2">
            ...
            <div><label class="text-xs font-bold text-gray-600">Active research limit per faculty</label><input type="number" name="max_active_research_per_faculty" value="{{ $fieldValue('max_active_research_per_faculty', 2) }}" min="1" max="2" required class="mt-1 block w-full rounded-xl border-gray-200 text-sm"><p class="mt-1 text-[11px] text-gray-400">The institutional hard limit is two concurrent approved projects across all calls and academic years.</p></div>
