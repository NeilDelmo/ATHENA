<x-app-layout>
    ...
    <div class="space-y-6">
        ...
        <section class="rounded-2xl border border-blue-200 bg-blue-50 p-5 text-xs leading-5 text-blue-800 dark:border-blue-900/60 dark:bg-blue-950/30 dark:text-blue-200">
            ...
            <p class="mt-1">Athena combines its built-in proposal paper field guide with active entries that match the faculty question, sends only the best excerpts to Gemini, and asks the model to cite them as <span class="font-black">[ATHENA 1]</span>, <span class="font-black">[ATHENA 2]</span>, and so on. Do not add confidential participant data, passwords, or unpublished sensitive results.</p>
        </section>
            ...
            <div class="divide-y divide-gray-100 dark:divide-slate-800">
                ...
                @empty
                    <div class="p-8 text-center">
                        ...
                        <p class="mt-1 text-xs text-gray-500">Athena also retrieves its built-in paper field guide, active research calls, and proposal-template instructions automatically.</p>
                    </div>
                @endforelse
            </div>
        </section>
