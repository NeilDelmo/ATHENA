                            ...
                            <tr class="{{ $projectStatus === 'delayed' || $pendingReportCount > 0 ? 'bg-amber-50/30' : '' }}">
                                ...
                                <td class="px-5 py-4 align-top">
                                    @if ($project->researchSecretary)
                                        <div class="flex min-w-52 items-center gap-2 rounded-xl border border-gray-200 bg-gray-50 p-2.5">
                                            <span class="flex h-9 w-9 shrink-0 items-center justify-center overflow-hidden rounded-full bg-white text-[10px] font-black text-gray-700 ring-1 ring-gray-200">
                                            ...
                                            <span class="min-w-0 flex-1"><span class="block truncate text-xs font-black text-gray-900">{{ $project->researchSecretary->name }}</span><span class="block text-[10px] leading-4 text-gray-500">Selected by project group</span></span>
                                        </div>
                                    @else
                                        <p class="max-w-52 rounded-xl border border-dashed border-gray-300 bg-gray-50 px-3 py-2 text-xs leading-5 text-gray-500">Awaiting selection by the project group.</p>
                                    @endif
                                </td>
